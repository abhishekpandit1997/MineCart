...
export default function Singup() {
    ...
    const saveData = (e) => {
        ...
        if (validation()) {
            ...
            let data = { fullName: fullName, email: email, password: password, phonenumber: phoneNumber }
            ...
            <div className="bg_signin">
                ...
                <Card style={{ width: '18rem', backgroundColor: "gray" }}>
                    ...
                    <Card.Body>
                        ...
                        <Form>
                            <Form.Group className="mb-3" controlId="formGroupEmail">
                                ...
                                {emailErr ? <span style={{ color: "red" }}>Please Enter Name</span> : ""}
                            </Form.Group>
                            ...
                            <Form.Group className="mb-3" controlId="formGroupEmail">
                                ...
                                <Form.Control type="number" placeholder="Enter number" onChange={(e) => setPhoneNumber(e.target.value)} />
                                {emailErr ? <span style={{ color: "red" }}>Please Enter Number</span> : ""}
                            </Form.Group>
                    ...
                    <div style={{ display: "flex", padding: 10, margin: 10 }}>
                        <p style={{ color: "white" }}>you have no accuont</p>{' '}<Link style={{ color: "orange" }} to="/Singin"> Sign In</Link>
